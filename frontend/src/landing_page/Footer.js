...
function Footer() {
  return (
    <footer>
      <div
        className="container-fluid border-top mt-5 p-5"
      ...
      >
        <div className="row mt-5">
          <div className="col">
            ...
            <p style={{ fontSize: "0.9rem" }} className="mt-3">
              &copy; 2010 - 2026, ViaTrade Broking Ltd.
            </p>
            <p style={{ fontSize: "0.9rem" }}>All rights reserved.</p>
          </div>
        ...
        <div
          className="mt-5 text-small text-muted px-5 pt-5"
        ...
        <div className="row text-muted ms-5 me-5 ps-5 pe-5 pt-5" style={{fontSize: "0.85rem"}}>
          ...
          <div className="col">Policies and procedures</div>
